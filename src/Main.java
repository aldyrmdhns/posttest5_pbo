    ...
    static ArrayList<Hero> dataHero = new ArrayList<>(){
        {
            ...
            add(new Hero("Eula", "Dance Of the Shimmering Wave", "Cryo", "Favonious Knight", "Mondstat", 342.18, 13225, 750.55, 130,55.0, 80.0));
            add(new Hero("Kaedahara Kazuha", "Scarlet Leaves Pursue Wild Waves", "Anemo", "The Crux", "Inazuma", 296.18, 13345, 806.55, 800,55.0, 80.0));
            add(new Hero("Zhongli", "Vago Mudo", "Geo", "Liyue Harbor", "Liyue", 251.18, 14695, 737.55, 50,55.0, 80.0));
        }
    };
